...
<body>
	...
	<form method="post" name="mailForm">
		<table border=1>
			<tr>
				<td>보내는사람 : <input type="text" name="from"
					value="dkanehdd@naver.com" />
				</td>
			</tr>
			<tr>
				<td>받는사람 : <input type="text" name="to" value="mnw232@gmail.com" />
				</td>
			</tr>
			<tr>
				<td>제목 : <input type="text" name="subject" value="" />
				</td>
			</tr>
			<tr>
