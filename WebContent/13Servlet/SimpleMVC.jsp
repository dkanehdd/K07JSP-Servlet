...
<body>
	...
	<ul>
		...
		<li>
			<a href="SimpleMVC?type=greeting&id=dkanehdd&pw=1111">
				SimpleMVC?type=greeting&id=dkanehdd&pw=1111
			</a>
		</li>
		<li>
	...
	이미지의 경로, CSS, JS파일을 상대경로로 링크했을때 경로가 깨지는 경우가 발생할수있기 때문이다
	아래 이미지의 경우 요청명이
		"/13Servlet/SimpleMVC"일때는 ../부분이 표시되고
		"/SimpleMVC"일때는 ./부분이 이미지가 표시될 것이다.
	-->
	<h3>이미지와 요청명</h3>
	<h4>../으로 이미지 표현</h4>
