...
<body>
	...
	엘리먼트를 통해 등록하게 된다. 이를 컨텍스트 초기화 파라미터라고한다.
	 --%>
	...
	<%--
	컨텍스트 초기화 파라미터의 <param-name> 속성전체를 가져온다.
	반환형은 열거형객체인 Enumeration이 된다.
	 --%>
	...
	while(names.hasMoreElements()){
		...
		//getInitParameter를 통해 <param-value>엘리먼트를 가져옴
	...
	얻어올수 있다. 사용시 context root를 제외한 /로 시작하는 절대경로를 입력해야한다.
	 --%>
	...
	반드시 매개변수 형태로 전달한후 내장객체의 클래스형으로 받은다음 사용해야한다.
	*/
