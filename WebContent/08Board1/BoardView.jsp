...
<%@ page language="java" contentType="text/html; charset=UTF-8"
    pageEncoding="UTF-8"%>
<!-- 회원제게시판이라 할지라도 상세보기는 로그인 없이 확인할수 있어야 한다.
특수한 경우에만 상세보기에 제한을 걸게된다. 비밀게시판, 1:1문의 등.... -->
<%
/*
검색후 파라미터 처리를 위한 추가부분 : 리스트에서 검색 후 상세보기, 그리고 다시 리스트보기를
	...
	<div class="row">		
		...
		<!-- ### 게시판의 body 부분 start ### -->
			...
			<div class="row mb-3">
				...
				또한 작성자에게만 노출되도록한다. 작성자가 아니라면 버튼은 
				숨김처리된다.
				*/
