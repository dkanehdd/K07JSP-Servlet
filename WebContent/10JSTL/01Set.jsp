...
<body>
	...
	set태그속성
		...
		scope : 영역을 지정하여 변수를 저장함.
			4가지 영역을 지정할수 있고 기본값은 가장좁은 page영역.
		scope영역을 지정하지 않으면 page영역에 저장된다.
	 -->
	<h2>set태그</h2>
	...
	<h3>EL로 출력</h3>
	<!-- 
	EL로 영역의 속성을 읽어올때는 xxScope를 생략하면 가장 좁은 영역인
	page영역을 읽어오게 되므로, 속성명이 동일하지 않다면 내장객체는 생략할수 있다.
	 -->
	<ul>
	...
	<!-- 
	set태그의 target, property속성은 자바빈 객체의 속성 혹은 컬렉션의
	값을 설정할때 사용하는 속성이다.
