...
<body>
	<fieldset>
		...
		<!-- 
			문자열 형태로 숫자가 전달되면 연산시 자동으로 숫자로 변경된후 연산된다.
			숫자로 변경할수 없는 문자가 포함된다면 예외가 발생한다.
		...
		<!-- 
			배열이나 컬렉션처럼 인덱스로 요소에 접근하는경우에도 .은 사용할 수 없다.
		 -->
		<ul>
		...
		<h4>배열</h4>
		<!-- 
		JSTL의 forEach태그를 통해 반복출력한다. 해당 문장은 배열이나 컬렉션의 크기만큼
		반복하는 확장for문 형태로 기술되었다.
		 -->
